...
const CardsRecrutement = ({ miseEnRelation, conseiller }) => {
  ...
  return (
    <div className="fr-card fr-mt-2w fr-card--no-border" style={{ backgroundColor: '#E8EDFF' }}>
      <div className="fr-card__body">
        <div className="fr-card__content fr-pb-2w">
          <h3 className="fr-card__title fr-h3">
            Demande de recrutement
          </h3>
          {miseEnRelation?.dateDeCreation &&
          <p className="fr-card__desc fr-text--lg fr-text--regular">
            Demande initi&eacute;e le {miseEnRelation ? dayjs(miseEnRelation.dateDeCreation).format('DD/MM/YYYY') : ''}
          </p>
          }
