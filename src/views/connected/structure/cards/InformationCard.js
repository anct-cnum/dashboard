...
const InformationCard = () => (
  <div className="fr-callout fr-fi-information-line fr-mb-7w">
    ...
    <p className="fr-callout__text">
      ...
      poursuite d&lsquo;un soutien financier de l&lsquo;Etat aux structures employant des Conum. &Agrave; ce titre, les
      ...
      <a className="fr-link"
        href={`${import.meta.env.VITE_APP_AIDE_HOSTNAME}/article/convention-de-subvention-et-renouvellement-comment-ca-marche-15gvzzn/?bust=1749829931105/`}
        target="_blank"
