...
import StatistiqueMateriel from './StatistiqueMateriel';
...
const StatistiquesActivites = ({
  ...
  const thematiquesToDisplay = isMediationNumeriqueAccompagnement ?
    ...
    activites.thematiques_demarches;
          ...
          <div className="fr-col-xl-6 fr-col-12">
            ...
            <div className="fr-flex fr-align-items-center">
              ...
              <QuantifiedShareLegend
                classeName="fr-pl-3w"
                quantifiedShares={activites.type_lieu}
                colors={canauxAccompagnementColors}
              />
            </div>
          </div>
...
StatistiquesActivites.propTypes = {
  totalCounts: PropTypes.object,
  activites: PropTypes.object,
  structures: PropTypes.array,
  wording: PropTypes.string,
};

export default StatistiquesActivites;
