...
// eslint-disable-next-line max-len
function getConseillersCoordonnes(page, dateDebut, dateFin, filtreParNomConseiller, filtreParRegion, filtreParDepartement, filtreParNomStructure, nomOrdre, ordre) {
  let {
    ordreColonne,
    filterDateStart,
    filterDateEnd,
